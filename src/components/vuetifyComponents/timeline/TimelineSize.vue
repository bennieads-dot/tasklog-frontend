...
<template>
  ...
  <div class="text-center mt-4">
    <v-timeline>
      ...
      <v-timeline-item color="amber-lighten-1" fill-dot size="small">
        <v-card>
      ...
      <v-timeline-item color="cyan-lighten-1" fill-dot>
        <v-card>
      ...
      <v-timeline-item color="red-lighten-1" fill-dot size="small">
        <v-card>
