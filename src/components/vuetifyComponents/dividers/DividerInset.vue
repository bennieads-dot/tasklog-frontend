            ...
            <v-list lines="two">
              ...
              >
                <template v-slot:subtitle>
                  <span class="font-weight-bold">Ali Connors</span> &mdash; I'll
                  be in your neighborhood doing errands this weekend. Do you
                  want to hang out?
                </template>
              </v-list-item>
              ...
              >
                <template v-slot:subtitle>
                  <span class="font-weight-bold">Sandra Adams</span> &mdash; Do
