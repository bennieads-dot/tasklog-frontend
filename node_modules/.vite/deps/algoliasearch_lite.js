...
var require_algoliasearch_lite_umd = __commonJS({
  "node_modules/algoliasearch/dist/algoliasearch-lite.umd.js"(exports, module) {
    !function(e, t) {
      ...
      function u(e2) {
        ...
        return { get: function(e3, t3) {
          ...
          return Promise.resolve().then(function() {
            var r4 = JSON.stringify(e3), n3 = a2()[r4];
            return Promise.all([n3 || t3(), void 0 !== n3]);
          }).then(function(e4) {
          ...
          return Promise.resolve().then(function() {
            var o2 = a2();
            return o2[JSON.stringify(e3)] = t3, n2().setItem(r2, JSON.stringify(o2)), t3;
          });
        }, delete: function(e3) {
          return Promise.resolve().then(function() {
            var t3 = a2();
      ...
      var m = { Read: 1, Write: 2, Any: 3 }, p = 1, v = 2, y = 3;
      function g(e2) {
      ...
      function w(e2, t2, n2, o2) {
        var u2 = [], i2 = function(e3, t3) {
        ...
        }(e2, o2), c2 = n2.method, l2 = n2.method !== O ? {} : r(r({}, n2.data), o2.data), f2 = r(r(r({ "x-algolia-agent": e2.userAgent.value }, e2.queryParameters), l2), o2.queryParameters), h2 = 0, d2 = function t3(r2, a2) {
          var l3 = r2.pop();
          if (void 0 === l3)
          ...
          var d3 = { data: i2, headers: s2, method: c2, url: S(l3, n2.path, f2), connectTimeout: a2(h2, e2.timeouts.connect), responseTimeout: a2(h2, o2.timeout) }, m2 = function(e3) {
            var t4 = { request: d3, response: e3, host: l3, triesLeft: r2.length };
            ...
            var o3 = m2(n3);
            return n3.isTimedOut && h2++, Promise.all([e2.logger.info("Retryable failure", x(o3)), e2.hostsCache.set(l3, g(l3, n3.isTimedOut ? y : v))]).then(function() {
              return t3(r2, a2);
            });
          }, onFail: function(e3) {
          ...
          return e2.requester.send(d3).then(function(e3) {
        ...
        return q(e2.hostsCache, t2).then(function(e3) {
          return d2(a(e3.statelessHosts).reverse(), e3.getTimeout);
        });
      }
      function j(e2) {
      ...
      var N = function(e2) {
        var t2 = e2.appId, n2 = function(e3, t3, r2) {
          ...
          var t3 = e3.hostsCache, r2 = e3.logger, n3 = e3.requester, a3 = e3.requestsCache, u2 = e3.responsesCache, i2 = e3.timeouts, s2 = e3.userAgent, c2 = e3.hosts, l2 = e3.queryParameters, f2 = { hostsCache: t3, logger: r2, requester: n3, requestsCache: a3, responsesCache: u2, timeouts: i2, userAgent: s2, headers: e3.headers, queryParameters: l2, hosts: c2.map(function(e4) {
            ...
            var r3 = d(t4, f2.timeouts.read), n4 = function() {
              return w(f2, f2.hosts.filter(function(e5) {
            ...
            }), e4, d(t4, f2.timeouts.write));
          } };
          return f2;
        }(r(r({ hosts: [{ url: "".concat(t2, "-dsn.algolia.net"), accept: m.Read }, { url: "".concat(t2, ".algolia.net"), accept: m.Write }].concat(c([{ url: "".concat(t2, "-1.algolianet.com") }, { url: "".concat(t2, "-2.algolianet.com") }, { url: "".concat(t2, "-3.algolianet.com") }])) }, e2), {}, { headers: r(r(r({}, n2.headers()), { "content-type": "application/x-www-form-urlencoded" }), e2.headers), queryParameters: r(r({}, n2.queryParameters()), e2.queryParameters) }));
        ...
        return function(t2, o2) {
          return Promise.all(t2.map(function(t3) {
            ...
            return k(e2)(t3.indexName, { methods: { searchForFacetValues: R } }).searchForFacetValues(u2, i2, r(r({}, o2), s2));
          }));
        };
      }, I = function(e2) {
      ...
      function Q(e2, t2, n2) {
        ...
        } }), responsesCache: s(), requestsCache: s({ serializable: false }), hostsCache: i({ caches: [u({ key: "".concat("4.14.2", "-").concat(e2) }), s()] }), userAgent: j("4.14.2").add({ segment: "Browser", version: "lite" }), authMode: h.WithinQueryParameters };
        return N(r(r(r({}, a2), n2), {}, { methods: { search: J, searchForFacetValues: E, multipleQueries: J, multipleSearchForFacetValues: E, customRequest: C, initIndex: function(e3) {
          return function(t3) {
            return k(e3)(t3, { methods: { search: F, searchForFacetValues: R, findAnswers: I } });
          };
        } } }));
      }
...
// dep:algoliasearch_lite
var algoliasearch_lite_default = require_algoliasearch_lite_umd();
export {
  algoliasearch_lite_default as default
};
